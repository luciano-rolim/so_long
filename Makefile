...
#    Updated: 2024/07/11 10:55:42 by lmeneghe         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
MLX_LIBS       = -Lmlx_linux -lmlx_Linux -L/usr/lib -lXext -lX11 -lz -lm

# Source Files
SRC_FILES       = codes/main.c

# Object files
OBJS_DIR        = objs/
OBJS            = $(SRC_FILES:codes/%.c=$(OBJS_DIR)%.o)
